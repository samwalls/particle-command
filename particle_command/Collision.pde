public Contact areContacting(GameObject a, GameObject b) {
...
private Contact circleIsContacting(GameObject circle, GameObject other) {
...
private Contact boxIsContacting(GameObject box, GameObject other) {
  // TODO
  return null;
}
...
public abstract class Collision extends Contact {
  ...
  public Collision(PVector normal, float penetration, GameObject a, GameObject b, float restitution) {
    ...
    // clip to [0,1]
    this.restitution = max(0, min(restitution, 1)); 
  }
